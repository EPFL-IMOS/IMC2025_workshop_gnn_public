...
class BaseTrainer:
    ...
    def fit(self, loaders):
        ...
        for epoch in range(start_epoch, self.n_epochs):
            ...
            # early stopping
            early_stopping(self.losses['eval'][-1], epoch)
...
class ForecastingTrainer(BaseTrainer):
    ...
    def compute_loss(self, batch, split):
        ...
        loss = self.criterion(true.view(-1, cfg.dataset.n_nodes, cfg.dataset.horizon), pred.view(-1, cfg.dataset.n_nodes, cfg.dataset.horizon))
